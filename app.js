let app = new Vue({
  ...
  methods: {
    ...
    fetch("https://storelessonapp-env.eba-gtpcag2c.eu-west-2.elasticbeanstalk.com/order12",
    {
        method: "POST",
        body: data
    })
    ...
    .then(function(data){ alert( JSON.stringify( data ) ) });
          ...
          fetch("https://storelessonapp-env.eba-gtpcag2c.eu-west-2.elasticbeanstalk.com/updateinformation",
          {
              method: "PUT",
              body: data1
          })
...
alert("fill in form");
  ...
  fetch("https://storelessonapp-env.eba-gtpcag2c.eu-west-2.elasticbeanstalk.com/order?id="+app.cart.id+"&name="+app.Nameofu+"&phonenumber="+app.phoneofu+"&spaces="+lessonleft).then(function (response) {
...
fetch("https://storelessonapp-env.eba-gtpcag2c.eu-west-2.elasticbeanstalk.com/update?subject="+app.subjects[app.cart.id].subject+"&spaceleft="+lessonleft).then(function (response) {
    response.json().then(function (json) {
     console.log("sent order");
  ...
  created: function () {
    ...
    fetch("https://storelessonapp-env.eba-gtpcag2c.eu-west-2.elasticbeanstalk.com/lessons").then(function (response) {
      response.json().then(function (json) {
        console.log(json);
